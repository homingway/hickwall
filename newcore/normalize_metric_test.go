...
func Test_normalize_metric_key_2(t *testing.T) {
	...
	// exp := "win.wmi.fs.d.cdfs.freespace.bytes" // ReplaceVersion
	exp := "win.wmi.fs.d.cdfs.free_space.bytes" // Regex Version
	res := NormalizeMetricKey(metric)
	t.Logf("*%s*", res)
	if res != exp {
		t.Error("failed")
...
func Test_normalize_metric_key_4(t *testing.T) {
	...
	// exp := "win.wmi.fs.d.cdfs.freespace.bytes.112121" // ReplaceVersion
	exp := "win.wmi.fs.d.cdfs.free_space.bytes.112121" // Regex Version
	res := NormalizeMetricKey(metric)
	t.Logf("*%s*", res)
	if res != exp {
		t.Error("failed")
...
func Test_normalize_metric_key_6(t *testing.T) {
	...
	// exp := "win.wmi.c_path_to_file" // ReplaceVersion
	exp := "win.wmi._c_path_to_file" // Regex Version
	res := NormalizeMetricKey(metric)
	t.Logf("*%s*", res)
	if res != exp {
		t.Error("failed")
...
func Test_normalize_metric_key_from_tag_1(t *testing.T) {
	...
	// exp := "win.wmi.fs.d.cdfs.free_space.bytes__1"  // ReplaceVersion
	exp := "win.wmi.fs.d.cdfs.free_space.bytes_1" // Regex Version
	res := NormalizeMetricKey(metric)
...
func Test_normalize_metric_key_from_tag_2(t *testing.T) {
	...
	// exp := "win.wmi.fs.d.cdfs.freespace.bytes__path_to_file"   // ReplaceVersion
	exp := "win.wmi.fs.d.cdfs.free_space.bytes_path_to_file" // Regex Version
	res := NormalizeMetricKey(metric)
	// res = NormalizeMetricKey(res)
	t.Logf("*%s*", res)
	if res != exp {
