...
func (c *hickwall_collector) CollectOnce() newcore.CollectResult {
	...
	md = append(md, newcore.NewDP("hickwall.client", "mem.Alloc", c.mem_stats.Alloc, nil, "", "", ""))
	md = append(md, newcore.NewDP("hickwall.client", "mem.TotalAlloc", c.mem_stats.TotalAlloc, nil, "", "", ""))
	md = append(md, newcore.NewDP("hickwall.client", "mem.Heap.Sys", c.mem_stats.HeapSys, nil, "", "", ""))
	md = append(md, newcore.NewDP("hickwall.client", "mem.Heap.Alloc", c.mem_stats.HeapAlloc, nil, "", "", ""))
	md = append(md, newcore.NewDP("hickwall.client", "mem.Heap.Idle", c.mem_stats.HeapIdle, nil, "", "", ""))
	md = append(md, newcore.NewDP("hickwall.client", "mem.Heap.Inuse", c.mem_stats.HeapInuse, nil, "", "", ""))
	md = append(md, newcore.NewDP("hickwall.client", "mem.Heap.Released", c.mem_stats.HeapReleased, nil, "", "", ""))
	md = append(md, newcore.NewDP("hickwall.client", "mem.Heap.Objects", c.mem_stats.HeapObjects, nil, "", "", ""))
	md = append(md, newcore.NewDP("hickwall.client", "mem.GC.NextGC", c.mem_stats.NextGC, nil, "", "", ""))
	md = append(md, newcore.NewDP("hickwall.client", "mem.GC.LastGC", c.mem_stats.LastGC, nil, "", "", ""))
	md = append(md, newcore.NewDP("hickwall.client", "mem.GC.NumGC", c.mem_stats.NumGC, nil, "", "", ""))
	md = append(md, newcore.NewDP("hickwall.client", "mem.GC.EnableGC", c.mem_stats.EnableGC, nil, "", "", ""))
