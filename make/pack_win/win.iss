...
[Files]
Source: "hickwall.exe"; DestDir: "{app}\{{version}}"; Permissions: users-readexec; Flags: ignoreversion touch
Source: "hickwall_helper.exe"; DestDir: "{app}\shared"; Permissions: users-readexec; Flags: ignoreversion touch
